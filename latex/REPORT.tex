...
\begin{minipage}[t]{0.65\textwidth}
    ...
    Project manager, hardware developer, enclosure design with Solidworks and 3D printing, music module, main.cpp, python utilities, documentation, and final report. Added UART water gun override prank. Paid for parts and tools and is going to keep the Wetris unit after the project is over.
...
\begin{minipage}[t]{0.3\textwidth}
    \vspace{0pt}
    \centering
   \includegraphics[width=3cm]{photos/JorgeRobles.jpg}
...
\begin{minipage}[t]{0.65\textwidth}
    ...
    \textbf{Email}: [rosburgroman@gmail.com]
    ...
    Lead programmer on the Wetris game logic, handling most of the design and debugging. Also handled majority of graphics using LCD libraries. Victim of previously mentioned UART water gun prank.
    
    \vspace{0.3cm}
    \textbf{About Me}:
    Currently a computer science student at UNR with a specific focus on game development including design and engine development along with some study into cybersecurity. Long-term goal of working in a large studio when I graduate as well as developing a strong indie dev portfolio.
