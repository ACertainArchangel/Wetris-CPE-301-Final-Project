...
\caption{Player getting wet from the water gun actuator}
\label{fig:intheface}
\end{figure}
...
\begin{minipage}[t]{0.65\textwidth}
    ...
    Project manager, hardware developer, enclosure design and 3d printing, music module, main.cpp, python utilities, documentation, and final report.
