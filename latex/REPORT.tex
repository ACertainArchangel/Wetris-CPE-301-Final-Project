...
\label{fig:schematic-casing-solidworks}
\end{figure}
...
\textbf{Major}: Electrical Engineering
    ...
    \textbf{GitHub}: \url{https:https://github.com/Sonylove5}
    \textbf{Role \& Contributions}:
    Successful design the coding, and deployment of the Potentiometer Module subsystem, a foundational UART communications layer, and the Water Gun actuator control mechanism.
